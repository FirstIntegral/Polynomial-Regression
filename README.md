I'll be applying a machine learning model (polynomial regression) to this dataset (02CN) and try to predict the next quarter's (Q1 2023) spending amount in the UK for "Tobacco"
